const todosVue = {
  ...
  REGISTER_GCM_TOKEN_URL: 'https://todosbackend.pdavila.2dam.acacha.org/api/v1/user/gcmtoken',
  GET_MESSAGES_URL: 'https://todosbackend.pdavila.2dam.acacha.org/api/v1/user/messages'
}
